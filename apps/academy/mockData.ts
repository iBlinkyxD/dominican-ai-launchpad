import { User, Space, Post, Course, Event, Chat, Notification, Badge } from './types';

// --- Badges ---
const BADGES: Record<string, Badge> = {
  helper: { id: 'b1', name: 'Top Helper', icon: '🤝', description: 'Consistently helps others in comments.', color: 'bg-blue-100 text-blue-700' },
  scholar: { id: 'b2', name: 'Scholar', icon: '📚', description: 'Completed 5+ courses.', color: 'bg-purple-100 text-purple-700' },
  innovator: { id: 'b3', name: 'Innovator', icon: '💡', description: 'Posted highly rated creative ideas.', color: 'bg-yellow-100 text-yellow-700' },
  guide: { id: 'b4', name: 'Community Guide', icon: '🧭', description: 'Welcomes new members.', color: 'bg-green-100 text-green-700' },
  star: { id: 'b5', name: 'Rising Star', icon: '✨', description: 'Fastest growing reputation this month.', color: 'bg-pink-100 text-pink-700' },
};
...
export const MOCK_POSTS: Post[] = [
  {
    ...
    authorAvatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&auto=format&fit=crop&q=60',
    spaceId: 's1',
  ...
  },
  {
    ...
    authorAvatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&auto=format&fit=crop&q=60',
    spaceId: 's4',
...
export const MOCK_COURSES: Course[] = [
  {
    ...
    description: 'Intro to AI and its impact on life, work, and opportunity in the Dominican Republic.',
    ...
    modules: [
      {
        ...
        title: 'Introduction',
        lessons: [
          { id: 'l1', title: 'What is AI?', duration: '5 min', isCompleted: false, type: 'video' },
        ],
      },
    ],
  },
  {
    ...
    description: 'Learn how data, algorithms, and logic power the intelligence behind machines.',
    thumbnail: 'https://images.unsplash.com/photo-1555255707-c07966088b7b?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    progress: 0,
    totalLessons: 12,
    completedLessons: 0,
    modules: [],
  },
  {
    ...
    description: 'See how computers learn from data and make predictions using real examples.',
...
export const MOCK_CHATS: Chat[] = [
  {
    id: 'ch1',
    participants: [{ id: 'u3', name: "Mr. O'Neill", avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&auto=format&fit=crop&q=60' }],
