          ...
          <div className="container mx-auto section-padding relative z-10">
            <ScrollAnimation animation="fade-up" className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Have questions about AI in the Dominican Republic? Want to collaborate or join our mission? 
            ...
            <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <ScrollAnimation key={info.title} animation="fade-up" delay={200 + index * 100}>
                    <a
                      href={info.href}
                    ...
                    >
                      ...
                      <div className="relative z-10 flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="font-display text-lg font-medium text-foreground">{info.title}</h3>
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-primary/10 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Santo Domingo, DR</p>
                      </div>
                    </div>
                  </div>
                </ScrollAnimation>
