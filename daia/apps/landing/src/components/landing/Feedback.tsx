...
const Feedback = () => {
  ...
  const translatedTestimonials = t("feedback.testimonials", {
    returnObjects: true,
  }) as any[];
      ...
      <div className="container mx-auto section-padding relative z-10">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-center">
            {testimonialLayout.map((layout, index) => {
              const testimonial = translatedTestimonials.find(
              ...
              return (
                ...
                >
                  <div
                    className={`group relative bg-card/90 backdrop-blur-xl rounded-3xl p-8 transition-all duration-500 h-full overflow-hidden border border-border/30 cursor-pointer ${layout.rotation} ${layout.hoverRotation}`}
                    style={{
                      boxShadow:
